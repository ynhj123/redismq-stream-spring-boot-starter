 ...
 */
@Component
@ConditionalOnBean(RedisMqConfig.class)
public class RedisStreamMqStartService {
    ...
    @Value("${spring.redis.stream.maxLen}")
    long maxLen = 1000;

    public RedisStreamMqStartService(@Qualifier("redisMqTemplate") RedisTemplate redisTemplate) {
